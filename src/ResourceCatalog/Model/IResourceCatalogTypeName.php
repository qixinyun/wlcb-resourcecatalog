...
interface IResourceCatalogTypeName
{
    const TYPE_NAME = array(
        ...
        IResourceCatalog::TYPE['AQPGS'] => '安全评估师',
        IResourceCatalog::TYPE['DLYSJYZJCYRY'] => '道路运输经营者及从业人员',
        IResourceCatalog::TYPE['DZSWPTCYRY'] => '电子商务平台从业人员',
        IResourceCatalog::TYPE['FDCZJ'] => '房地产中介',
        IResourceCatalog::TYPE['GWY'] => '公务员',
        IResourceCatalog::TYPE['HJYXPJJJYJCCYRY'] => '环境影响评价及检验监测从业人员',
        IResourceCatalog::TYPE['JDCJSY'] => '机动车驾驶员',
        IResourceCatalog::TYPE['JLGCS'] => '监理工程师',
        IResourceCatalog::TYPE['JRCYRY'] => '金融从业人员',
        IResourceCatalog::TYPE['JZRY'] => '家政人员',
        IResourceCatalog::TYPE['JZS'] => '建造师',
        IResourceCatalog::TYPE['KDY'] => '快递员',
        IResourceCatalog::TYPE['KYRY'] => '科研人员',
        IResourceCatalog::TYPE['QYFRDBJXGFZR'] => '企业法人代表及相关负责人',
        IResourceCatalog::TYPE['RZRY'] => '认证人员',
        IResourceCatalog::TYPE['SHGZZ'] => '社会工作者',
        IResourceCatalog::TYPE['SJS'] => '审计师',
        IResourceCatalog::TYPE['SWS'] => '税务师',
        IResourceCatalog::TYPE['SYDWGZRY'] => '事业单位工作人员',
        IResourceCatalog::TYPE['TJCYRY'] => '统计从业人员',
        IResourceCatalog::TYPE['WSPGS'] => '卫生评估师',
        IResourceCatalog::TYPE['XFZCGCS'] => '消防注册工程师',
        IResourceCatalog::TYPE['ZCCHS'] => '注册测绘师',
        IResourceCatalog::TYPE['ZCKJS'] => '注册会计师',
        ...
        IResourceCatalog::TYPE['CXDX'] => '诚信典型',
        //@position
    );
}
